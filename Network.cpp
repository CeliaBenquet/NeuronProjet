...
Network::Network()
{
	...
	neurons_.push_back(new Neuron(EXT_CURRENT)); //0
	neurons_.push_back(new Neuron(0.0)); //1
	...
	connexions_=vector <vector<int> >({{0,1},{0,0}});
